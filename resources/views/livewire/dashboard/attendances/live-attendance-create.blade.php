                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-nowrap">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="checkbox" wire:model="rollCall.{{ $student->id }}" id="defaultCheck{{ $student->id }}">
                                                                            <label class="form-check-label" for="defaultCheck{{ $student->id }}">
                                                                            حاضر
                                                                            </label>
                                                                        </div>
                                                                    </td>
