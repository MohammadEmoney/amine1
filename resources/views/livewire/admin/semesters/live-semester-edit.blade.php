...
<div class="container-fluid">
    <livewire:admin.components.live-breadcrumb :items="[['title' => 'لیست کلاس ها', 'route' => route('admin.semesters.index')], ['title' => 'ویرایش کلاس']]" />
    <div class="card">
        <div class="card-body">
            <h3 class="">ویرایش کلاس {{ $semester->course?->title_with_part }}</h3>
            <div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form wire:submit.prevent="submit">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="exampleInputtext1" class="form-label">شهریه
                                                            *</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3" wire:ignore>
                                                        ...
                                                        <select id="students" class="form-control select2" multiple
                                                            wire:model.live="data.students"
                                                            onchange="livewireSelect2Multi('data.students', this)">
                                                            <option value="">انتخاب نمایید</option>
                                                            @foreach ($students as $key => $value)
                                                                <option value="{{ $value->id }}" @selected(in_array($value->id, $data['students']))>
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            var data = [];
            var studentIds = {!! json_encode($data['students']) !!};

            $.each(studentIds, function (key, value) {
                data.push(value);
            });

            $('#students').val(data).trigger('change');
