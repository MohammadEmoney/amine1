    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                @include('livewire.admin.users.components.filters')
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">#</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-nowrap">
                                        ...
                                        <i class="cursor-pointer ti ti-pencil text-warning ms-2" data-bs-toggle="tooltip" data-bs-placement="top" wire:click="edit({{ $user->id }})" title="ویرایش"></i>
