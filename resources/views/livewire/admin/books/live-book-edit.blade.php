<div class="container-fluid">
    <livewire:admin.components.live-breadcrumb :items="[['title' => 'لیست کتاب ها', 'route' => route('admin.books.index')], ['title' => 'ویرایش کتاب ' . $book->title]]" />
    <div class="card">
        <div class="card-body">
            <h3 class="">ویرایش کتاب {{ $book->title }}</h3>
            <div>
