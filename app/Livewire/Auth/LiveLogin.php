...
class LiveLogin extends Component
{
    ...
    public function sendCode()
    {
        ...
        if($user){
            ...
            $user->save();
            $phone = $user->phone ?: $user->userInfo?->mobile_1;
            $response = $this->sendVerificationCode($phone, $user->first_name, $user->otp_code);
    ...
    public function verification()
    {
        ...
        $redirect = $this->user?->register_complete ? 'profile.classes.index' : 'profile.edit';
