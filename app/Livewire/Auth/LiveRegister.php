...
class LiveRegister extends Component
{
    ...
    public function validations()
    {
        $this->validate([
            ...
            'data.national_code' => ['required', 'string', 'max:255', $this->isForeigner ? "" : new ValidNationalCode($this->isForeigner), 'unique:users,national_code,' . $this->user?->id],
