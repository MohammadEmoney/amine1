...
class LiveQuestionCreate extends Component
{
    ...
    public function submit()
    {
        try {
            ...
            return redirect()->to(route('profile.questions.index', ['evaluation' => $this->evaluation]));
        } catch (\Exception $e) {
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard.questions.live-question-create', compact('types'))
