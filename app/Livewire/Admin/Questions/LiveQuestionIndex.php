...
class LiveQuestionIndex extends Component
{
    ...
    {
        return redirect()->to(route('admin.questions.create', ['evaluation' => $this->evaluation]));
    }

    public function edit($id)
    {
        return redirect()->to(route('admin.questions.edit', ['evaluation' => $this->evaluation, 'question' => $id]));
    }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.questions.live-question-index', compact('questions'))->extends('layouts.admin-panel')->section('content');
    }
}
