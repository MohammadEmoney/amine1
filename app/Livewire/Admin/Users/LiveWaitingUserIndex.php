...
class LiveWaitingUserIndex extends Component
{
    ...
    {
        return redirect()->to(route('admin.users.waiting.edit', $id));
    }
    ...
    public function render()
    {
        ...
        $users = User::query()->role('waiting-student')->with(['userInfo']);
        ...
        return view('livewire.admin.users.live-waiting-user-index', compact('users', 'courses'))
