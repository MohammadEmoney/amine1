...
class LiveSettings extends Component
{
    ...
    public function load()
    {
        ...
        $this->personalSetting = Auth::user()->settings ?? [];
    }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.settings.live-settings')->extends('layouts.admin-panel')->section('content');
    }
}
